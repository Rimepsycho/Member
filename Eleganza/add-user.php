                        ...
                        <div class="card mb-4">
                            ...
                            <div class="container">
                                ...
                                <form action="doAddUser.php" method="post">
                                    <div class="mb-3">
                                        <label for="">姓名</label>
                                        <input type="name" class="form-control" name="name" minlength="3" maxlength="30" required
                                        placeholder="請輸入真實姓名">
                                    </div>
                                    <div class="mb-3">
                                        <label for="">帳號</label>
                                        <input type="account" class="form-control" name="account" minlength="3" maxlength="12" required
                                        placeholder="請輸入3~12字元">
                                    </div>
                                    <div class="mb-3">
                                        <label for="">密碼</label>
